...
export const AnnualReport = () => {
    ...
    const GET_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-find-year"
    const GET_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/find-year"
    const GET_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/out-year"
    const GET_TRANSIT_API_URL = "https://phma-rmu.herokuapp.com/transit-year"
        ...
        <div className='annual-template'>
            ...
            {detail &&
                <div className='annual-wrap' ref={myRef}>
                    <div className='report-header'>(Report Summary) Annual</div>
                            ...
                            <Doughnut
                                ...
                                data={{
                                    ...
                                    datasets: [{
                                        ...
                                        backgroundColor: ['red', 'yellow', '#5FA6F8']
                                    }]
                                }}
            ...
            {Summary &&
                <div className='detail-report' ref={myRef}>
                    <div className='report-header'>(Report Detailed) Annual</div>
