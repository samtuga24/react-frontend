        ...
        <div className='dashboard-wrapper'>
            ...
            <div className='panel-wrap'>
                <div className='side-nav'>
                    ...
                    <div className='side-nav-item incoming-icon' onClick={outClick}>
                    ...
                    <div className='side-nav-item incoming-icon' onClick={manageClick}>
                        {manage && <FontAwesomeIcon icon={faAngleDown} className='arrow-icon' size='lg' />}
                        <FontAwesomeIcon icon={faAngleRight} className='arrow-icon' id={manageOut ? 'hide-arrow' : null} size='lg' />
                        <p>Manage Users</p>
                    </div>

                    {
                        ...
                        <div className='upload-wrap'>
                            <div className='upload-minute' onClick={userClick}>
                                <FontAwesomeIcon icon={faUserPlus} className='up-arrow' size='lg' />
                                <p className='file-text'>Add User</p>
                            </div>
                            <div className='upload-minute' onClick={viewClick}>
                                <FontAwesomeIcon icon={faEye} className='up-arrow' size='lg' />
                                <p className='file-text'>View Users</p>
                            </div>
                        </div>
                    }
