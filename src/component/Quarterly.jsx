...
export const Quarterly = () => {
    ...
    const COUNT_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-first-count"
    const COUNT_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/first-count"
    const COUNT_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/first-count-out"
    ...
    const GET_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-first-quarter"
    const GET_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/first-quarter"
    const GET_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/first-quarter-out"
    const GET_TRANSIT_API_URL = "https://phma-rmu.herokuapp.com/first-quarter-transit"
        ...
        <div className='annual-template'>
            ...
            {detail &&
                <div className='annual-wrap' ref={myRef}>
                    <div className='report-header'>(Report Summary) 1st Quarter</div>
            ...
            {Summary &&
                ...
                <div className='detail-report' ref={myRef}>
                    <div className='report-header'>(Report Detailed) 1st Quarter</div>
