...
export const Q2 = () => {
  ...
  const COUNT_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-second-count"
  const COUNT_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/second-count"
  const COUNT_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/second-count-out"
  ...
  const GET_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-second-quarter"
  const GET_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/second-quarter"
  const GET_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/second-quarter-out"
  const GET_TRANSIT_API_URL = "https://phma-rmu.herokuapp.com/second-quarter-transit"
    ...
    <div className='annual-template'>
      ...
      {detail &&
        <div className='annual-wrap' ref={myRef}>
          <div className='report-header'>(Report Summary) 2nd Quarter</div>
      ...
      {Summary &&
        ...
        <div className='detail-report' ref={myRef}>
          <div className='report-header'>(Report Detailed) Second Quarter</div>
