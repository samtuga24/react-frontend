...
export const Q3 = () => {
  ...
  const COUNT_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-third-count"
  const COUNT_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/third-count"
  const COUNT_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/third-count-out"
  ...
  const GET_DIARY_API_URL = "https://phma-rmu.herokuapp.com/diary-third-quarter"
  const GET_INCOMING_API_URL = "https://phma-rmu.herokuapp.com/third-quarter"
  const GET_OUTGOING_API_URL = "https://phma-rmu.herokuapp.com/third-quarter-out"
  const GET_TRANSIT_API_URL = "https://phma-rmu.herokuapp.com/third-quarter-transit"
    ...
    <div className='annual-template'>
      ...
      {detail &&
        <div className='annual-wrap' ref={myRef}>
          <div className='report-header'>(Report Summary) 3nd Quarter</div>
      ...
      {Summary &&
        ...
        <div className='detail-report' ref={myRef}>
          <div className='report-header'>(Report Detailed) Third Quarter</div>
